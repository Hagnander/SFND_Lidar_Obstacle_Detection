...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    //renderPointCloud(viewer,inputCloud,"inputCloud");
    pcl::PointCloud<pcl::PointXYZI>::Ptr filterCloud = pointProcessorI->FilterCloud(inputCloud, 0.2 , Eigen::Vector4f (-15, -6.5, -2, 1), Eigen::Vector4f (40, 6.5, 10, 1));
    ...
    //renderPointCloud(viewer, segmentCloud.first, "ObstaceleCloud", Color(0, 0, 1));
